...
| P1 | Content core + signed starter dataset | in progress (P1.1–P1.6 complete; P1.7 verification pending) | yes | `docs/plan/P1.md` |
...
- **P1.7** — Source/provenance/license registry (implemented; verification pending)

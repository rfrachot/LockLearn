...
| P3 | Learning/SRS/sessions/stats | in progress (P3.1 pending gate) | yes | `docs/plan/P3.md` |
...
- **P3.1** — ReviewEvent audit log and progress projection (implemented; verification pending)

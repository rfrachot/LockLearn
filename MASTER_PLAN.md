...
| P2 | Profiles/tracks/ACL | in progress (P2.1–P2.2 complete; P2.3 pending gate) | yes | `docs/plan/P2.md` |
...
- **P2.3** — Backend ACL and privacy filtering (implemented; verification pending)

...
| P3 | Learning/SRS/sessions/stats | in progress (P3.1–P3.3 complete; P3.4 pending gate) | yes | `docs/plan/P3.md` |
...
- **P3.4** — Verified-retrieval gate and signal weighting (implemented; verification pending)

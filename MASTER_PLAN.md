...
| P2 | Profiles/tracks/ACL | in progress (P2.1–P2.4 complete; P2.5 pending gate) | yes | `docs/plan/P2.md` |
...
- **P2.5** — Learning quotas, goals and load forecast (implemented; verification pending)

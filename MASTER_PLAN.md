...
| P1 | Content core + signed starter dataset | in progress (P1.1–P1.7 complete; P1.8 verification pending) | yes | `docs/plan/P1.md` |
...
- **P1.8** — Dataset build pipeline and source adapters (implemented; verification pending)

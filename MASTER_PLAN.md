...
| P3 | Learning/SRS/sessions/stats | in progress (P3.1–P3.7 complete; P3.8 pending gate) | yes | `docs/plan/P3.md` |
...
- **P3.8** — Persistent sessions, concurrency and cross-client resume (implemented; verification pending)

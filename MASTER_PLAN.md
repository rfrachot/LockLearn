...
| P1 | Content core + signed starter dataset | in progress (P1.1–P1.9 complete; P1.10 verification pending) | yes | `docs/plan/P1.md` |
...
- **P1.10** — Signed first-run mini dataset (implemented; verification pending)

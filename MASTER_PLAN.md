...
| P3 | Learning/SRS/sessions/stats | in progress (P3.1–P3.4 complete; P3.5 pending gate) | yes | `docs/plan/P3.md` |
...
- **P3.3** — ReviewPolicy V1 core (complete)
- **P3.4** — Verified-retrieval gate and signal weighting (complete)
- **P3.5** — Sibling burial, prerequisites and confusable introduction spacing (implemented; verification pending)

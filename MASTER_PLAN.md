...
| P1 | Content core + signed starter dataset | in progress (P1.1–P1.4 complete; P1.5 implemented, verification pending) | yes | `docs/plan/P1.md` |
...
- **P1.5** — Tags, packs, prerequisites and Japanese curation primitives (implemented; verification pending)

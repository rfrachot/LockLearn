...
| P2 | Profiles/tracks/ACL | in progress (P2.1–P2.3 complete; P2.4 pending gate) | yes | `docs/plan/P2.md` |
...
- **P2.4** — Track configuration, pack pinning and card rules (implemented; verification pending)

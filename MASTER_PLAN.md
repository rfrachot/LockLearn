...
| P1 | Content core + signed starter dataset | in progress (P1.1–P1.2 complete; P1.3 implemented, verification pending) | yes | `docs/plan/P1.md` |
...
- **P1.3** — Content blocks, grading metadata and safe rich text (implemented; verification pending)
